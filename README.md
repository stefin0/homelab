...
- [Ansible Proxmox](https://docs.ansible.com/projects/ansible/latest/collections/community/proxmox/index.html)
- [Cloud-init](https://cloudinit.readthedocs.io/en/latest/)
- [mergerfs](https://trapexit.github.io/mergerfs/latest/)
...
- [Subiquity Autoinstall](https://canonical-subiquity.readthedocs-hosted.com/en/latest/reference/autoinstall-reference.html)
- [Terraform](https://developer.hashicorp.com/terraform)
- [Terraform Proxmox](https://registry.terraform.io/providers/bpg/proxmox/latest/docs)
...
- [Jellfyin](https://docs.linuxserver.io/images/docker-jellyfin/) 
- [Jellyseerr](https://docs.jellyseerr.dev/getting-started/docker) 
- [MariaDB (Nextcloud)](https://docs.linuxserver.io/images/docker-mariadb/) 
...
- [Open Thread Border Router](https://openthread.io/guides/border-router/build-docker) 
- [Pi-hole](https://github.com/pi-hole/docker-pi-hole) 
- [Piper](https://hub.docker.com/r/rhasspy/wyoming-piper) 
- [Prowlarr](https://docs.linuxserver.io/images/docker-prowlarr/) 
- [qBit Manage](https://github.com/StuffAnThings/qbit_manage/wiki/Docker-Installation) 
...
- [Traefik](https://doc.traefik.io/traefik/getting-started/docker/)
